...
export default function NewContactPage() {
  ...
  const { createContact, error, clearError } = useContactStore()
  ...
  const onSubmit = async (data: CreateContactInput) => {
    ...
    clearError()
    try {
      await createContact(data, avatarFile)
      toast.success("Thêm liên hệ thành công")
      router.push("/contacts")
    } catch (err: any) {
      toast.error(err?.response?.data?.message || "Thêm liên hệ thất bại")
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <article className="animate-fade-in-up">
        ...
        <header className="mb-8 sm:mb-10 pb-6 sm:pb-8 border-b border-border">
          ...
          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed">
            Thêm người thân hoặc liên hệ khẩn cấp để nhận thông báo khi có cảnh báo lũ lụt
          </p>
        </header>
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <div className="mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                Điền thông tin người thân hoặc liên hệ khẩn cấp
              </p>
            </div>
            ...
            {error && (
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-border">
                ...
                >
                  {isLoading ? "Đang thêm..." : "Thêm liên hệ"}
                </Button>
                <Button 
                  type="button" 
                  variant="outline" 
