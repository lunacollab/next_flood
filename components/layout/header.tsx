...
import { Bell, LogOut, Menu, User, Shield, X, KeyRound } from "lucide-react"
...
export function Header() {
  ...
  useEffect(() => {
    // Chỉ fetch notifications khi đã hydrate xong, authenticated, và có user
    if (isHydrated && isAuthenticated && user && user.id) {
      fetchNotifications()
    }
    // Chỉ fetch khi các điều kiện thay đổi
